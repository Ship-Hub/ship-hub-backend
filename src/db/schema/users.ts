...
export const users = mysqlTable('users', {
  ...
  communityMutedUntil: timestamp('community_muted_until'),
  communityMutedById: varchar('community_muted_by_id', { length: 36 }),
  pinnedMemoryIds: json('pinned_memory_ids').$type<string[]>().default([]),
  isAdmin: tinyint('is_admin').default(0),
  platformAdmin: tinyint('platform_admin').default(0),
  communityAdmin: tinyint('community_admin').default(0),
